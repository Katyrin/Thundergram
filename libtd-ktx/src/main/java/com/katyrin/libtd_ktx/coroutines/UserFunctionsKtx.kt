 ...
 */
suspend fun TelegramFlow.blockUser(userId: Int): Unit = sendFunctionLaunch(BlockUser(userId))
...
suspend fun TelegramFlow.getBlockedUsers(offset: Int, limit: Int): Users =
    sendFunctionAsync(GetBlockedUsers(offset, limit))
 ...
 */
suspend fun TelegramFlow.getSupportUser(): User = sendFunctionAsync(GetSupportUser())
 ...
 * @return [User] Represents a user.
 */
suspend fun TelegramFlow.getUser(userId: Int): User = sendFunctionAsync(GetUser(userId))
...
suspend fun TelegramFlow.getUserFullInfo(userId: Int): UserFullInfo =
    sendFunctionAsync(GetUserFullInfo(userId))
 ...
 */
suspend fun TelegramFlow.getUserPrivacySettingRules(
    setting: UserPrivacySetting?
): UserPrivacySettingRules = sendFunctionAsync(GetUserPrivacySettingRules(setting))
...
suspend fun TelegramFlow.getUserProfilePhotos(
    ...
    offset: Int,
    limit: Int
): UserProfilePhotos = sendFunctionAsync(GetUserProfilePhotos(userId, offset, limit))
...
suspend fun TelegramFlow.registerUser(firstName: String?, lastName: String?): Unit =
    sendFunctionLaunch(RegisterUser(firstName, lastName))
...
suspend fun TelegramFlow.setSupergroupUsername(supergroupId: Int, username: String?): Unit =
    sendFunctionLaunch(SetSupergroupUsername(supergroupId, username))
...
): Unit = sendFunctionLaunch(SetUserPrivacySettingRules(setting, rules))
...
suspend fun TelegramFlow.setUsername(username: String?): Unit =
    sendFunctionLaunch(SetUsername(username))
 ...
 * @param userId User identifier.
 */
suspend fun TelegramFlow.unblockUser(userId: Int): Unit = sendFunctionLaunch(UnblockUser(userId))