...
import com.katyrin.libtd_ktx.coroutines.createBasicGroupChat
import com.katyrin.libtd_ktx.coroutines.getBasicGroup
import com.katyrin.libtd_ktx.coroutines.getBasicGroupFullInfo
...
interface BasicGroupKtx : BaseKtx {
     ...
     */
    suspend fun BasicGroup.createChat(force: Boolean): TdApi.Chat =
        api.createBasicGroupChat(this.id, force)
     ...
     */
    suspend fun BasicGroup.get(): BasicGroup = api.getBasicGroup(this.id)
     ...
     */
    suspend fun BasicGroup.getFullInfo(): TdApi.BasicGroupFullInfo =
        api.getBasicGroupFullInfo(this.id)
}