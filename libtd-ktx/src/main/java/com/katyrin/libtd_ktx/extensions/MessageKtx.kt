...
interface MessageKtx : BaseKtx {
     ...
     */
    suspend fun Message.deleteChatReplyMarkup(chatId: Long): Unit =
        api.deleteChatReplyMarkup(chatId, id)
    ...
    ): Message = api.editMessageCaption(chatId, id, replyMarkup, caption)
    ...
    ): Message = api.editMessageLiveLocation(chatId, id, replyMarkup, location)
    ...
    ): Message = api.editMessageMedia(chatId, id, replyMarkup, inputMessageContent)
     ...
     * @return [TdApi.Message] Describes a message.
     */
    suspend fun Message.editReplyMarkup(chatId: Long, replyMarkup: ReplyMarkup?): Message =
        api.editMessageReplyMarkup(chatId, id, replyMarkup)
     ...
     * immediately.
     */
    suspend fun Message.editSchedulingState(
        chatId: Long,
        schedulingState: MessageSchedulingState?
    ): Unit = api.editMessageSchedulingState(chatId, id, schedulingState)
    ...
    suspend fun Message.editText(
        ...
        replyMarkup: ReplyMarkup?,
        inputMessageContent: InputMessageContent?
    ): Message = api.editMessageText(chatId, id, replyMarkup, inputMessageContent)
     ...
     */
    suspend fun Message.getCallbackQueryAnswer(
        chatId: Long,
        payload: CallbackQueryPayload?
    ): CallbackQueryAnswer = api.getCallbackQueryAnswer(chatId, id, payload)
     ...
     */
    suspend fun Message.getGameHighScores(chatId: Long, userId: Int): GameHighScores =
        api.getGameHighScores(chatId, id, userId)
    ...
    ): HttpUrl = api.getLoginUrl(chatId, id, buttonId, allowWriteAccess)
     ...
     */
    suspend fun Message.getLoginUrlInfo(chatId: Long, buttonId: Int): LoginUrlInfo =
        api.getLoginUrlInfo(chatId, id, buttonId)
     ...
     * @return [TdApi.Message] Describes a message.
     */
    suspend fun Message.get(chatId: Long): Message = api.getMessage(chatId, id)
     ...
     * @return [TdApi.HttpUrl] Contains an HTTP URL.
     */
    suspend fun Message.getLink(chatId: Long): HttpUrl = api.getMessageLink(chatId, id)
     ...
     * @return [TdApi.Message] Describes a message.
     */
    suspend fun Message.getLocally(chatId: Long): Message = api.getMessageLocally(chatId, id)
     ...
     */
    suspend fun Message.getPaymentForm(chatId: Long): PaymentForm = api.getPaymentForm(chatId, id)
     ...
     */
    suspend fun Message.getPaymentReceipt(chatId: Long): PaymentReceipt =
        api.getPaymentReceipt(chatId, id)
    ...
    suspend fun Message.getPollVoters(
        ...
        offset: Int,
        limit: Int
    ): Users = api.getPollVoters(chatId, id, optionId, offset, limit)
     ...
     */
    suspend fun Message.getPublicLink(chatId: Long, forAlbum: Boolean): PublicMessageLink =
        api.getPublicMessageLink(chatId, id, forAlbum)
     ...
     * @return [TdApi.Message] Describes a message.
     */
    suspend fun Message.getReplied(chatId: Long): Message = api.getRepliedMessage(chatId, id)
     ...
     */
    suspend fun Message.openContent(chatId: Long): Unit = api.openMessageContent(chatId, id)
     ...
     */
    suspend fun Message.pinChat(chatId: Long, disableNotification: Boolean): Unit =
        api.pinChatMessage(chatId, id, disableNotification)
    ...
    ): PaymentResult = api.sendPaymentForm(chatId, id, orderInfoId, shippingOptionId, credentials)
    ...
    suspend fun Message.setGameScore(
        ...
        score: Int,
        force: Boolean
    ): Message = api.setGameScore(chatId, id, editMessage, userId, score, force)
     ...
     */
    suspend fun Message.setPollAnswer(chatId: Long, optionIds: IntArray?): Unit =
        api.setPollAnswer(chatId, id, optionIds)
     ...
     * @param replyMarkup The new message reply markup; for bots only.
     */
    suspend fun Message.stopPoll(chatId: Long, replyMarkup: ReplyMarkup?): Unit =
        api.stopPoll(chatId, id, replyMarkup)
    ...
    suspend fun Message.validateOrderInfo(
        ...
        orderInfo: OrderInfo?,
        allowSave: Boolean
    ): ValidatedOrderInfo = api.validateOrderInfo(chatId, id, orderInfo, allowSave)
}