 ...
 */
suspend fun TelegramFlow.addSavedAnimation(animation: InputFile?): Unit =
    sendFunctionLaunch(TdApi.AddSavedAnimation(animation))
...
suspend fun TelegramFlow.getSavedAnimations(): Animations =
    sendFunctionAsync(TdApi.GetSavedAnimations())
...
suspend fun TelegramFlow.removeSavedAnimation(animation: InputFile?): Unit =
    sendFunctionLaunch(TdApi.RemoveSavedAnimation(animation))