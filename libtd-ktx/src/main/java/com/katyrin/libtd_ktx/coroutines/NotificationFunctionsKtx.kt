 ...
 * chats.
 */
suspend fun TelegramFlow.getScopeNotificationSettings(
    scope: NotificationSettingsScope?
): ScopeNotificationSettings = sendFunctionAsync(TdApi.GetScopeNotificationSettings(scope))
...
suspend fun TelegramFlow.processPushNotification(payload: String?): Unit =
    sendFunctionLaunch(TdApi.ProcessPushNotification(payload))
...
suspend fun TelegramFlow.removeNotification(notificationGroupId: Int, notificationId: Int): Unit =
    sendFunctionLaunch(TdApi.RemoveNotification(notificationGroupId, notificationId))
 ...
 */
suspend fun TelegramFlow.removeNotificationGroup(
    notificationGroupId: Int,
    maxNotificationId: Int
): Unit = sendFunctionLaunch(TdApi.RemoveNotificationGroup(notificationGroupId, maxNotificationId))
 ...
 */
suspend fun TelegramFlow.resetAllNotificationSettings(): Unit =
    sendFunctionLaunch(TdApi.ResetAllNotificationSettings())
 ...
 */
suspend fun TelegramFlow.setScopeNotificationSettings(
    scope: NotificationSettingsScope?,
    notificationSettings: ScopeNotificationSettings?
): Unit = sendFunctionLaunch(TdApi.SetScopeNotificationSettings(scope, notificationSettings))