...
suspend fun TelegramFlow.getGameHighScores(
    ...
    messageId: Long,
    userId: Int
): GameHighScores = sendFunctionAsync(TdApi.GetGameHighScores(chatId, messageId, userId))
 ...
 * @return [GameHighScores] Contains a list of game high scores.
 */
suspend fun TelegramFlow.getInlineGameHighScores(
    inlineMessageId: String?,
    userId: Int
): GameHighScores = sendFunctionAsync(TdApi.GetInlineGameHighScores(inlineMessageId, userId))
...
suspend fun TelegramFlow.setGameScore(
    ...
    TdApi.SetGameScore(chatId, messageId, editMessage, userId, score, force)
)
...
suspend fun TelegramFlow.setInlineGameScore(
    ...
    TdApi.SetInlineGameScore(inlineMessageId, editMessage, userId, score, force)
)