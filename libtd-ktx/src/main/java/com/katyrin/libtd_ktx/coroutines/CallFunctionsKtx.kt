...
suspend fun TelegramFlow.acceptCall(callId: Int, protocol: CallProtocol?): Unit =
    sendFunctionLaunch(TdApi.AcceptCall(callId, protocol))
...
suspend fun TelegramFlow.createCall(userId: Int, protocol: CallProtocol?): CallId =
    sendFunctionAsync(TdApi.CreateCall(userId, protocol))
...
suspend fun TelegramFlow.discardCall(
    ...
    duration: Int,
    connectionId: Long
): Unit = sendFunctionLaunch(TdApi.DiscardCall(callId, isDisconnected, duration, connectionId))
...
suspend fun TelegramFlow.searchCallMessages(
    ...
    limit: Int,
    onlyMissed: Boolean
): Messages = sendFunctionAsync(TdApi.SearchCallMessages(fromMessageId, limit, onlyMissed))
...
suspend fun TelegramFlow.sendCallDebugInformation(callId: Int, debugInformation: String?): Unit =
    sendFunctionLaunch(TdApi.SendCallDebugInformation(callId, debugInformation))
...
): Unit = sendFunctionLaunch(TdApi.SendCallRating(callId, rating, comment, problems))
...
suspend fun TelegramFlow.testCallBytes(x: ByteArray?): TestBytes =
    sendFunctionAsync(TdApi.TestCallBytes(x))

/**
 * Suspend function, which does nothing; for testing only. This is an offline method. Can be called
 * before authorization.
 */
suspend fun TelegramFlow.testCallEmpty(): Unit = sendFunctionLaunch(TdApi.TestCallEmpty())
...
suspend fun TelegramFlow.testCallString(x: String?): TestString =
    sendFunctionAsync(TdApi.TestCallString(x))
...
suspend fun TelegramFlow.testCallVectorInt(x: IntArray?): TestVectorInt =
    sendFunctionAsync(TdApi.TestCallVectorInt(x))
...
suspend fun TelegramFlow.testCallVectorIntObject(x: Array<TestInt>?): TestVectorIntObject =
    sendFunctionAsync(TdApi.TestCallVectorIntObject(x))
...
suspend fun TelegramFlow.testCallVectorString(x: Array<String>?): TestVectorString =
    sendFunctionAsync(TdApi.TestCallVectorString(x))
...
suspend fun TelegramFlow.testCallVectorStringObject(x: Array<TestString>?): TestVectorStringObject =
    sendFunctionAsync(TdApi.TestCallVectorStringObject(x))